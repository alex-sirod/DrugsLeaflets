...
if __name__ == '__main__':
    ...
    # for token in doc:
    #     print("{:>20}{:>20}{:>10}{:>15}{:>10}{:>5}{:>5}{:>5}{:>5}".format(
    #         token.text, "lemma:" + token.lemma_, token.pos_, token.tag_, token.dep_, token.shape_ + " is:", token.is_sent_start,
    #           token.is_stop, token.is_title, token.is_ancestor(doc[0])))
    ...
    #leaflet3 = Leaflet(r'leaflets_pdf/bula_1689362421673 - Amoxicilina.pdf') # HEPARINOX - enoxaparina sodica
    # leaflet4 = Leaflet(r'leaflets_pdf/bula_1699032061377 - tigeciclina.pdf')  # TROMBOFOL heparina sódica
    # leaflet4.save_text()
    ...
    # leaflet3.get_interactions()
    #leaflet3.get_metadata()
